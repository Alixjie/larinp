...
C_FLAGS = -I include -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -fno-stack-protector -fno-pie -no-pie   -c
...
.PHONY:clean 
clean:
	$(RM) $(S_OBJECTS) $(C_OBJECTS) jorny_kernel parasite parasite.d parasite.o parasite.out *.d
